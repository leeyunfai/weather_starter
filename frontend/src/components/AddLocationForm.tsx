    ...
    return (
      <div className="grid gap-2">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-2xl border border-[var(--card-border)] bg-[var(--sidebar-card-bg)] px-3 py-2.5 text-sm font-medium text-[var(--text-primary)] backdrop-blur-xl hover:bg-white/[0.12]"
        >
          <PlusIcon />
  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={busy}
        className="rounded-md border border-white/20 bg-white/10 px-3 py-2 text-xs font-semibold text-[var(--text-primary)] hover:bg-white/15 disabled:cursor-not-allowed disabled:opacity-60"
      >
        {activity === 'locating'
      ...
      <div className="grid grid-cols-2 gap-2">
        <label className="grid min-w-0 gap-1">
          ...
          <input
            ...
            required
            disabled={busy}
            className="w-full min-w-0 rounded-md border border-white/15 bg-white/10 px-2 py-1.5 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)]"
          />
        </label>
        <label className="grid min-w-0 gap-1">
      ...
      <div className="flex items-center justify-end gap-2">
        <button
          ...
          onClick={cancel}
          disabled={busy}
          className="rounded-md px-2.5 py-1.5 text-xs font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] disabled:cursor-not-allowed disabled:opacity-60"
        >
          Cancel
        </button>
        <button
